...
def execute(block, config):
    ...
    predictions_rescaled = np.ndarray(shape=(1,144))
    load_data_file = np.loadtxt("/Users/gchgomes/3pcf_integrator/output/fastnc_at_cosmoDESY3_emuconfigs.txt")

    predictions_rescaled[:,0::4] = -1 * load_data_file[25:169:4]
    predictions_rescaled[:,1::4] = -1 * load_data_file[26:169:4]
    predictions_rescaled[:,2::4] = -1 * load_data_file[27:169:4]
    predictions_rescaled[:,3::4] = -1 * load_data_file[28:169:4]
